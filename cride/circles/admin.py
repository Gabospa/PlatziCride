...
class CircleAdmin(admin.ModelAdmin):
    ...
    def make_verified(slef, request, queryset):
        """Make circles verified."""
        queryset.update(verified=True)
    make_verified.short_drescription = 'Make selected circles verified'

    def make_unverified(self, request, queryset):
        """Make circles unverified.""" 
        queryset.update(verified=False)
    make_unverified.short_drescription = 'Make selected circles unverified'
    ...
    download_todays_rides.short_drescription = 'Download today rides to cvs'
