...
class Ride(CRideModel):
    ...
    # SET_NULL, indica que aunque se borre el usuario o el circulo el ride no se borrara
    ...
    # Como usamos User de nuevo, debemos asignar un related name
    ...
    is_active = models.BooleanField(
        'active status',
        default=True,
        help_text='Used for disabling the ride or marking as finished'
    )
