...
class Invitation(CRideModel):
    ...
    A circle invitation is a text that acts as unique code
    that grats access to a specific circle.
    This codes are generated by users that are
    already members of the circle and have
