...
class MembershipViewSet(mixins.ListModelMixin,
    ...
    def invitations(self, request, *arfs, **kwargs):
        """ Retrieve a member's invitations breakdown.j

        Will return a list containing all the members that
        have used its invitations and another list containging the
